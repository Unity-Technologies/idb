...
// Fork-local: also referenced by the generated header. Upstream's own include
// paths happen to reach these first; a consumer importing a stub header
// directly does not.
#import <FBControlCore/FBProcessIO.h>
#import <FBControlCore/FBProcessStream.h>

// Fork-local: the generated header declares conformances to AVFoundation
// protocols but only @imports AVFoundation under Clang modules, which are not
// available in Objective-C++ translation units such as Unity's Pram.
